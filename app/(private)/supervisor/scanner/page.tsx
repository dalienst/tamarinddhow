      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight flex items-center gap-2">
            <QrCode className="w-8 h-8 text-emerald-600" /> Digital Ticket Scanner
          </h1>
                ...
                >
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 uppercase font-mono font-semibold"
                    />
                  </div>
                  <button
                    type="submit"
              ...
              <div className="pt-6 border-t border-slate-100">
                {scanStatus === "loading" ? (
                  <div className="flex flex-col items-center justify-center py-8 space-y-3">
                    <div className="animate-spin rounded-full h-8 w-8 border-2 border-emerald-600 border-t-transparent" style={{ borderRadius: "50%" }} />
